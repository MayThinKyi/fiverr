...
const Featured = () => {
  return (
    <div className='featured lg:px-10 py-[100px] '>
        <div className='flex flex-col justify-center'>
            <h1 className='text-white text-5xl font-bold'>Find the perfect <em className='font-italic' >freelance</em></h1>
            <h1 className='text-white mt-3 mb-7 text-5xl font-bold'>services for your business</h1>
        <div className='featuredInputContainer  mb-6  flex items-center rounded'>
             <AiOutlineSearch/>
             <input className=' py-3 px-5 lg:w-[40vw]' placeholder='"Try "building mobile app""' />
